...
OD_ATTR_PERSIST_COMM OD_PERSIST_COMM_t OD_PERSIST_COMM = {
    ...
    .x1A01_TPDOMappingParameter = {
        ...
        .applicationObject1 = 0x60010110,
        .applicationObject2 = 0x60010220,
        .applicationObject3 = 0x60010308,
        .applicationObject4 = 0x60010408,
    ...
    .x6001_errors_State = {
        .highestSub_indexSupported = 0x04,
        .header = 0x0000,
        .voltage_current_vals = 0x00000000,
        .temperatures = 0x00,
        .states = 0x00
    }
};
...
typedef struct {
    ...
    OD_obj_record_t o_6001_errors_State[5];
} ODObjs_t;
...
static CO_PROGMEM ODObjs_t ODObjs = {
    ...
    .o_6001_errors_State = {
        {
            .dataOrig = &OD_PERSIST_COMM.x6001_errors_State.highestSub_indexSupported,
            .subIndex = 0,
            .attribute = ODA_SDO_R,
            .dataLength = 1
        },
        {
            .dataOrig = &OD_PERSIST_COMM.x6001_errors_State.header,
            .subIndex = 1,
            .attribute = ODA_TPDO | ODA_MB,
            .dataLength = 2
        },
        {
            .dataOrig = &OD_PERSIST_COMM.x6001_errors_State.voltage_current_vals,
            .subIndex = 2,
            .attribute = ODA_TPDO | ODA_MB,
            .dataLength = 4
        },
        {
            .dataOrig = &OD_PERSIST_COMM.x6001_errors_State.temperatures,
            .subIndex = 3,
            .attribute = ODA_TPDO,
            .dataLength = 1
        },
        {
            .dataOrig = &OD_PERSIST_COMM.x6001_errors_State.states,
            .subIndex = 4,
            .attribute = ODA_TPDO,
            .dataLength = 1
        }
...
static OD_ATTR_OD OD_entry_t ODList[] = {
    ...
    {0x6001, 0x05, ODT_REC, &ODObjs.o_6001_errors_State, NULL},
